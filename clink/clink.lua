...
local clink_lua_file = clink.get_env('USERPROFILE')..'\\scoop\\apps\\clink\\current\\clink.lua'
...
local cmder_config_dir = clink.get_env('USERPROFILE')..'/scoop/persist/clink/prompt/'
